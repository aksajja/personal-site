...
```bash
git clone https://github.com/aksajja/aksajja.github.io.git
cd personal-site
...
* Special thanks to [@mldangelo](https://github.com/mldangelo/personal-site/) for making such an awesome personal-site available for free with no strings attached! 
